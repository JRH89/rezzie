...
export function Workspace({ accessToken, onBilling, onHome, onSignOut }: { accessToken?: string; onBilling: () => void; onHome: () => void; onSignOut?: () => void }) {
      ...
      <main className="workspace-main">
        <section className="workspace-content">
          ...
          {step === 3 && <>
            ...
            {(creditPackPrice || subscriptionPrice) && credentialMode === "subscription" && <div className="billing-actions"><button onClick={onBilling} type="button">Manage credits and plans</button></div>}
