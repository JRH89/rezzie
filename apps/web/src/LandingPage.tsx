    ...
    <div className="landing">
      <header className="marketing-header">
        ...
        <nav className="marketing-nav" aria-label="Main navigation">
          <a href="/features">Features</a><a href="#how-it-works">How it works</a><a href="/blog">Resources</a><a href="/faq">FAQ</a><a href="/about">About</a>
        </nav>
      ...
      <footer className="marketing-footer"><a className="brand-link" href="/"><BrandMark /></a><nav className="footer-links" aria-label="Footer navigation"><a href="/features">Features</a><a href="/about">About</a><a href="/blog">Blog</a><a href="/faq">FAQ</a></nav><p>Tailor the signal. Keep the truth.</p><span>© {new Date().getFullYear()} Rezzie</span></footer>
    </div>
  );
}
