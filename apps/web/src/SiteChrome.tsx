...
export function PublicFooter() {
  return <footer className="marketing-footer"><a className="brand-link" href="/"><BrandMark /></a><nav className="footer-links" aria-label="Footer navigation"><a href="/features">Features</a><a href="/how-it-works">How it works</a><a href="/pricing">Pricing</a><a href="/safety">Safety</a><a href="/about">About</a><a href="/blog">Blog</a><a href="/faq">FAQ</a><a href="/#support">Support</a><a href="/privacy">Privacy</a></nav><p>Tailor the signal. Keep the truth.</p><span>© {new Date().getFullYear()} Rezzie</span></footer>;
}
