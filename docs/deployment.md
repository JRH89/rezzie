...
2. Configure the OIDC application’s allowed redirect origin and API audience. Update the React app’s auth integration to attach its bearer token; the API will reject production header-based identities.
