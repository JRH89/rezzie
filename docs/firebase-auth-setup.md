...
3. In **Authentication → Settings → Authorized domains**, add the production web domain and `localhost` for local development.
...
5. Configure the API to validate Firebase ID tokens in `apps/api/.env`:
