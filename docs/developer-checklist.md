...
| QA | Run local API/web checks | complete | 2026-09-07: 59 API tests, 12 web interaction tests, and 7 extension tests passed; Ruff, extension/web ESLint, and both production builds passed |
| Engineering | Preserve usable resume document structure | in progress | Rich editor formatting and DOCX-derived portable style profiles carry into matching DOCX/PDF outputs; PDF source preview and page targeting remain available. Exact template-aware rewriting and saved-source style persistence remain pending private original-file storage; see `docs/document-fidelity.md` |
