...
| QA | Run local API/web checks | complete | 2026-09-06: 54 API tests and Ruff passed with test-safe host/origin settings; 11 web interaction tests, 7 extension tests, ESLint, and web/extension production builds previously passed |
