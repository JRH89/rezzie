...
| QA | Run local API/web checks | complete | 2026-09-06: 46 API tests, 10 web interaction tests, 5 extension tests, Ruff, ESLint, and web/extension production builds passed |
