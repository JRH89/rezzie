...
| QA | Run local API/web checks | complete | 2026-09-06: 51 API tests, 11 web interaction tests, 7 extension tests, Ruff, ESLint, and web/extension production builds passed |
